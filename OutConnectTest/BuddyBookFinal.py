...
GlobalServerPort = 9487
GlobalClientPort = 9420
...
class MyQt(QWidget):
    ...
    def CreateFunctionLayout(self):
        ...
        self.PostArticelButton = QPushButton("Post Article")

        self.AddFriendButton.clicked.connect(self.AddFriendDialogOCL)
        # self.PostArticelButton.clicked.connect()

        self.FunctionLayout.addWidget(self.AddFriendButton)
        self.FunctionLayout.addWidget(self.PostArticelButton)
    ...
    def commentArticle(self, parentArticleID):
        ...
        commentDialog = self.AddArticleDialog(self)
